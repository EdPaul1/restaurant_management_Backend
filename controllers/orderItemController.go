...
func GetOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured when fetching order item"})
			return
		}
...
func CreateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		for _, orderItem := range OrderItemPack.Order_items {
			...
			var num = toFixed(*orderItem.Unit_price, 2) // Rounds the price to 2 decimal places
...
func UpdateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := "error occurred while updating order item"
